...
const Page = ({}: Props) => {
    const pageObject = {
        hero: {
            ...
            button: '<button class="w-[350px] h-[62px] mt-10 font-bold uppercase flex items-center justify-center bg-[#55555A] rounded text-[#E5E5E8] text-[18px] leading-normal">Замовити дзвінок</button>'
        },
        products: {},
        benefits: {},
        clients: {}
